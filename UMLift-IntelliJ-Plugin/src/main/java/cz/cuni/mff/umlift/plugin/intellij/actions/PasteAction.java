...
/**
 * The PasteAction class provides functionality for pasting content within the context of
 ...
 * <p>
 * This class ensures that the paste action is only enabled and visible in the IDE
 * if the currently selected file is an UMLet-compatible file, identified by its
 * specific file extension.
 * <p>
 * Overrides the following methods:
 * <p>
 * actionPerformed - Executes the paste action triggered by the user. If the current
...
public class PasteAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        if (file != null && Objects.equals(file.getExtension(), UMLET_FILE_SUFFIX)) {
            MenuFactoryIntelliJ.getInstance().doAction(MenuConstants.PASTE, null);
        } else {
